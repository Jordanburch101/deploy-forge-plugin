...
(function($) {
    ...
    const GitHubDeployAdmin = {
        ...
        deployNow: function(e) {
            ...
            button.prop('disabled', true).html('<span class="github-deploy-loading"></span> ' + githubDeployAdmin.strings.deploying);
        ...
        refreshStatus: function(e) {
            ...
            button.prop('disabled', true).html('<span class="github-deploy-loading"></span>');
        ...
        autoRefresh: function() {
            ...
            if ($('.github-deploy-dashboard').length > 0) {
                setInterval(function() {
                    ...
                    const pendingCount = $('.deployment-status.status-pending, .deployment-status.status-building').length;
                    if (pendingCount > 0) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        // Show success message
                        const $notice = $('<div class="notice notice-success is-dismissible" style="margin: 15px 0;">' +
...
(function($) {
    ...
    const NonceRefresh = {
        ...
        showWarning: function() {
            ...
            const $notice = $('<div class="notice notice-warning is-dismissible" style="margin: 15px 0;">' +
