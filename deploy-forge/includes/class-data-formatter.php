 ...
 *
 * Provides static methods for formatting data structures used
 * throughout the plugin, eliminating duplicate formatting logic.
 *
 ...
 *
 * Utility class with static methods for formatting various data types
 * including repositories, workflows, deployments, and branches.
 *
 * @since 1.0.0
 */
class Deploy_Forge_Data_Formatter {
	 ...
	 * @return array Formatted deployment data with escaped values.
	 */
	 ...
	 *
	 * @param object $deployment Deployment object from database.
	 * @return array Formatted deployment for JSON response.
	 */
	...
	public static function format_repositories( array $repos ): array {
		return array_map( array( self::class, 'format_repository_for_select' ), $repos );
	}
	...
	public static function format_workflows( array $workflows ): array {
		return array_map( array( self::class, 'format_workflow_for_select' ), $workflows );
	}
	...
	public static function format_branches( array $branches ): array {
		return array_map( array( self::class, 'format_branch_for_select' ), $branches );
	}
	...
	public static function format_deployments( array $deployments ): array {
		return array_map( array( self::class, 'format_deployment_for_json' ), $deployments );
	}
	 ...
	 * @return array Formatted connection details with escaped values.
	 */
