...
<div class="deploy-forge-wizard-wrap">
    <div class="deploy-forge-wizard">
        ...
        <div class="wizard-progress">
            <div class="wizard-steps">
                <div class="wizard-step <?php echo $current_step === 1 ? 'active' : ''; ?>">
                    ...
                    <div class="wizard-step-label"><?php esc_html_e('Welcome', 'deploy-forge'); ?></div>
                </div>
                <div class="wizard-step <?php echo $current_step === 2 ? 'active' : ''; ?>">
                    <div class="wizard-step-circle">2</div>
                    <div class="wizard-step-label"><?php esc_html_e('Connect', 'deploy-forge'); ?></div>
                </div>
                <div class="wizard-step <?php echo $current_step === 3 ? 'active' : ''; ?>">
                    <div class="wizard-step-circle">3</div>
                    <div class="wizard-step-label"><?php esc_html_e('Repository', 'deploy-forge'); ?></div>
                </div>
                <div class="wizard-step <?php echo $current_step === 4 ? 'active' : ''; ?>">
                    <div class="wizard-step-circle">4</div>
                    <div class="wizard-step-label"><?php esc_html_e('Method', 'deploy-forge'); ?></div>
                </div>
                <div class="wizard-step <?php echo $current_step === 5 ? 'active' : ''; ?>">
                    <div class="wizard-step-circle">5</div>
                    <div class="wizard-step-label"><?php esc_html_e('Options', 'deploy-forge'); ?></div>
                </div>
                <div class="wizard-step <?php echo $current_step === 6 ? 'active' : ''; ?>">
                    <div class="wizard-step-circle">6</div>
                    <div class="wizard-step-label"><?php esc_html_e('Review', 'deploy-forge'); ?></div>
                </div>
            </div>
        </div>
        ...
        <div class="wizard-content">
            ...
            <div class="wizard-step-content <?php echo $current_step === 1 ? 'active' : ''; ?>" data-step="1">
                <?php include DEPLOY_FORGE_PLUGIN_DIR . 'templates/setup-wizard/step-welcome.php'; ?>
            </div>

            <!-- Step 2: Connect to GitHub -->
            <div class="wizard-step-content <?php echo $current_step === 2 ? 'active' : ''; ?>" data-step="2">
                <?php include DEPLOY_FORGE_PLUGIN_DIR . 'templates/setup-wizard/step-connect.php'; ?>
            </div>

            <!-- Step 3: Select Repository -->
            <div class="wizard-step-content <?php echo $current_step === 3 ? 'active' : ''; ?>" data-step="3">
                <?php include DEPLOY_FORGE_PLUGIN_DIR . 'templates/setup-wizard/step-repository.php'; ?>
            </div>

            <!-- Step 4: Deployment Method -->
            <div class="wizard-step-content <?php echo $current_step === 4 ? 'active' : ''; ?>" data-step="4">
                <?php include DEPLOY_FORGE_PLUGIN_DIR . 'templates/setup-wizard/step-method.php'; ?>
            </div>

            <!-- Step 5: Deployment Options -->
            <div class="wizard-step-content <?php echo $current_step === 5 ? 'active' : ''; ?>" data-step="5">
                <?php include DEPLOY_FORGE_PLUGIN_DIR . 'templates/setup-wizard/step-options.php'; ?>
            </div>

            <!-- Step 6: Review & Complete -->
            <div class="wizard-step-content <?php echo $current_step === 6 ? 'active' : ''; ?>" data-step="6">
                <?php include DEPLOY_FORGE_PLUGIN_DIR . 'templates/setup-wizard/step-review.php'; ?>
            </div>
